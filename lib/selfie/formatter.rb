...
module Selfie
  class Formatter
    DEFAULT_COLUMNS = 80
    IMAGE_DIMENSIONS = Struct.new(:main, :thumb).new({:width  => nil, :height => 3}, :width => nil, :height => 3)
...
#RSpec.configuration.add_setting :selfie_image_dimensions, :default => SelfieFormatter::IMAGE_DIMENSIONS
